 ...
 for m in g['meshes']:
  for q in m['primitives']:
   ...
   if res:
    ...
    if 'TEXCOORD_0'in arrays:key=np.c_[key,np.floor(arrays['TEXCOORD_0']*10).astype(int)]
