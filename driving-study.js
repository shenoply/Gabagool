(()=>{
 ...
 new THREE.GLTFLoader().load('rat-animation-pack67.glb',asset=>{
  ...
  study.model.traverse(mesh=>{if(!mesh.isSkinnedMesh)return;const full=mesh.geometry,inside=full.clone(),si=full.attributes.skinIndex,sw=full.attributes.skinWeight,hidden=new Set(),keep=[];
