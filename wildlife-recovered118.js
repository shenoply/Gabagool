(() => {
  ...
  function addMap171() {
    ...
    map.innerHTML = '<b>Yard</b><i data-id="home">⌂</i><i data-id="den" aria-label="Lizard den">🦎</i><i data-id="bird" aria-label="Osprey transport">🦅</i><i data-id="mission-vinyl" aria-label="Lost vinyl" title="Lost vinyl">♪</i><i data-id="mission-pool" aria-label="Pool key" title="Pool key">🔑</i><i data-id="pip">●</i>';
