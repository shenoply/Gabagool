...
(() => {
  ...
  const propsTick=tickProps57;tickProps57=function(dt){propsTick(dt);showMission186();const launch=$('heavenLaunch186');if(launch)launch.style.display=$('modal').style.display==='flex'?'none':'block';const map=$('miniMap171');if(map&&!map.querySelector('[data-heaven186]')){const marker=document.createElement('i');marker.dataset.heaven186='true';marker.textContent='★';marker.title='Stairway to Heaven gate';marker.style.cssText='position:absolute;color:#ffda67;font-style:normal;font-size:18px;transform:translate(-50%,-50%);margin-left:-10px;margin-top:-12px;filter:drop-shadow(0 1px 2px #182c27)';map.appendChild(marker);}const heavenMark=map?.querySelector('[data-heaven186]');if(heavenMark)mapPoint171(heavenMark,29.5,19);if(nearGate57()){ui.prompt.textContent='E · Stairway to Heaven';$('padE').textContent='Enter';}};
