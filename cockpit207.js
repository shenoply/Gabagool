...
(()=>{
 ...
 const svg=name=>`<svg viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">${name==='opacity'?'<path d="M12 3a9 9 0 1 0 0 18z" fill="currentColor"/>':''}<path d="${paths[name]}"/></svg>`;
 ...
 body #navigation201[data-map-size=large]{width:min(230px,calc(100vw - 24px))!important}
 ...
 body #navigation201 #miniMap171 b{display:none}body #navigation201[data-map-size=hidden]{width:44px!important}
 body #navigation201[data-map-size=hidden]>:not(#mapTools207){display:none!important}
 ...
 const before=tickWorld38;tickWorld38=function(dt){before(dt);const map=document.getElementById('miniMap171');if(map&&!map.querySelector('.mapTerrain207')){map.insertAdjacentHTML('afterbegin','<svg class="mapTerrain207" viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden="true" style="position:absolute;inset:0;width:100%;height:100%;pointer-events:none;opacity:.55"><path d="M9 42H92V94H9Z" fill="#5e794b" stroke="#d0b784" stroke-width=".6"/><path d="M21 15H79V33H21Z" fill="none" stroke="#b0aaa0" stroke-width="6"/><path d="M48 43V33" stroke="#b0aaa0" stroke-width="5"/><path d="M21 15H79V33H21Z" fill="none" stroke="#f0d896" stroke-dasharray="2 2" stroke-width=".6"/><text x="50" y="8" font-size="5" text-anchor="middle" fill="#fff1cc">CITY</text></svg>');}rail.dataset.inactive207=String(phase!=='scavenge'||photo.active||!gameplayActive());};
