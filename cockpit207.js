...
(()=>{
 ...
 const before=tickWorld38;tickWorld38=function(dt){before(dt);const cameraButton=quick.querySelector('[data-icon207=camera]');if(cameraButton){const label='Cockpit';cameraButton.textContent=label;cameraButton.title=label+' — tap to change';cameraButton.setAttribute('aria-label',label+' — tap to change');}rail.classList.toggle('map-panel207',!cockpit205.drawer.hidden);const map=document.getElementById('miniMap171');if(map&&!map.querySelector('.mapTerrain207')){map.insertAdjacentHTML('afterbegin','<svg class="mapTerrain207" viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden="true" style="position:absolute;inset:0;width:100%;height:100%;pointer-events:none;opacity:.55"><path d="M9 42H92V94H9Z" fill="#5e794b" stroke="#d0b784" stroke-width=".6"/><path d="M48 43V12" stroke="#b0aaa0" stroke-width="5"/><path d="m44 17 4-5 4 5" fill="none" stroke="#f0d896" stroke-width="1"/><text x="50" y="8" font-size="5" text-anchor="middle" fill="#fff1cc">ORIGINAL CITY ↑</text></svg>');}rail.dataset.inactive207=String(phase!=='scavenge'||photo.active||!gameplayActive());};
