(() => {
  ...
  function constrainLimbs113(actor, moving) {
    ...
    // Keep roughly half of the authored diagonal gait, but remove the source
    // clip's vertical arm flips and stretched fingers.
    settle(roots, moving ? .52 : .72);
    settle(mids, moving ? .58 : .76);
    settle(toes, moving ? .70 : .84);
  }
